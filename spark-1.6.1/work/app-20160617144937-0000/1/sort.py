...
conf = SparkConf().setAppName("Sort5").setMaster("spark://192.168.43.28:7077").set("spark.eventLog.enabled","true").set("spark.eventLog.dir","../generated_driver_log/").set("spark.speculation","true")
