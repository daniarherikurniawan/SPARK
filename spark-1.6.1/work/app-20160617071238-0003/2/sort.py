...
conf = SparkConf().setAppName("Sort4").setMaster("spark://192.168.1.3:7077").set("spark.eventLog.enabled","true").set("spark.eventLog.dir","../generated_driver_log/").set("spark.speculation","true")
