...
// no position
  class HadoopRDD$ implements org.apache.spark.Logging, scala.Serializable {
  /**
  ...
  public  scala.Option<org.apache.spark.rdd.HadoopRDD.SplitInfoReflections> SPLIT_INFO_REFLECTIONS () { throw new RuntimeException(); }
    scala.collection.Seq<java.lang.String> convertSplitLocationInfo (java.lang.Object[] infos) { throw new RuntimeException(); }
}
