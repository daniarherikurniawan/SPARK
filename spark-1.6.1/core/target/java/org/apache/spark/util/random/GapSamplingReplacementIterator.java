...
/** advance to first sample as part of object construction. */
  ...
  // not preceding
  public   GapSamplingReplacementIterator (scala.collection.Iterator<T> data, double f, java.util.Random rng, double epsilon, scala.reflect.ClassTag<T> evidence$5) { throw new RuntimeException(); }
