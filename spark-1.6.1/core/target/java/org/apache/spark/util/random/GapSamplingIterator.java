package org.apache.spark.util.random;
  ...
  // not preceding
  public   GapSamplingIterator (scala.collection.Iterator<T> data, double f, java.util.Random rng, double epsilon, scala.reflect.ClassTag<T> evidence$4) { throw new RuntimeException(); }
