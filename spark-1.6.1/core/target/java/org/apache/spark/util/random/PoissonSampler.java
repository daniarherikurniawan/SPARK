...
public  class PoissonSampler<T extends java.lang.Object> implements org.apache.spark.util.random.RandomSampler<T, T> {
  ...
  public   PoissonSampler (double fraction, boolean useGapSamplingIfPossible, scala.reflect.ClassTag<T> evidence$2) { throw new RuntimeException(); }
  public   PoissonSampler (double fraction, scala.reflect.ClassTag<T> evidence$3) { throw new RuntimeException(); }
