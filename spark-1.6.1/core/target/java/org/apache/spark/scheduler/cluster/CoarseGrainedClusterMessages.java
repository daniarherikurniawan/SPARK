...
// no position
  ...
  static public  class RegisteredExecutor implements org.apache.spark.scheduler.cluster.CoarseGrainedClusterMessage, org.apache.spark.scheduler.cluster.CoarseGrainedClusterMessages.RegisterExecutorResponse, scala.Product, scala.Serializable {
    ...
    // not preceding
    public   RegisteredExecutor (java.lang.String hostname) { throw new RuntimeException(); }
  }
  // no position
  static public  class RegisteredExecutor$ extends scala.runtime.AbstractFunction1<java.lang.String, org.apache.spark.scheduler.cluster.CoarseGrainedClusterMessages.RegisteredExecutor> implements scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
