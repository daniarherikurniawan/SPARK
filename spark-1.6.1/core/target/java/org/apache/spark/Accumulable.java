 ...
 * param:  internal if this {@link Accumulable} is internal. Internal {@link Accumulable}s will be reported
 *                 to the driver via heartbeats. For internal {@link Accumulable}s, <code>R</code> must be
...
public  class Accumulable<R extends java.lang.Object, T extends java.lang.Object> implements java.io.Serializable {
  ...
  // not preceding
     Accumulable (R initialValue, org.apache.spark.AccumulableParam<R, T> param, scala.Option<java.lang.String> name, boolean internal) { throw new RuntimeException(); }
     Accumulable (R initialValue, org.apache.spark.AccumulableParam<R, T> param, boolean internal) { throw new RuntimeException(); }
  ...
  /**
   * If this {@link Accumulable} is internal. Internal {@link Accumulable}s will be reported to the driver
   * via heartbeats. For internal {@link Accumulable}s, <code>R</code> must be thread safe so that they can be
   * reported correctly.
   * @return (undocumented)
   */
    boolean isInternal () { throw new RuntimeException(); }
  /**
