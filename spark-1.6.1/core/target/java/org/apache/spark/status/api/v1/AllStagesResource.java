package org.apache.spark.status.api.v1;
  ...
  static public  org.apache.spark.status.api.v1.TaskMetrics convertUiTaskMetrics (org.apache.spark.executor.TaskMetrics internal) { throw new RuntimeException(); }
  static public  org.apache.spark.status.api.v1.InputMetrics convertInputMetrics (org.apache.spark.executor.InputMetrics internal) { throw new RuntimeException(); }
  static public  org.apache.spark.status.api.v1.OutputMetrics convertOutputMetrics (org.apache.spark.executor.OutputMetrics internal) { throw new RuntimeException(); }
  static public  org.apache.spark.status.api.v1.ShuffleReadMetrics convertShuffleReadMetrics (org.apache.spark.executor.ShuffleReadMetrics internal) { throw new RuntimeException(); }
  static public  org.apache.spark.status.api.v1.ShuffleWriteMetrics convertShuffleWriteMetrics (org.apache.spark.executor.ShuffleWriteMetrics internal) { throw new RuntimeException(); }
