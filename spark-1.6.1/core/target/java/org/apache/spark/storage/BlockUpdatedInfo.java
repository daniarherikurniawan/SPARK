...
public  class BlockUpdatedInfo implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   BlockUpdatedInfo (org.apache.spark.storage.BlockManagerId blockManagerId, org.apache.spark.storage.BlockId blockId, org.apache.spark.storage.StorageLevel storageLevel, long memSize, long diskSize, long externalBlockStoreSize) { throw new RuntimeException(); }
}
