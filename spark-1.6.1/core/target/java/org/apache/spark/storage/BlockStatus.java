...
public  class BlockStatus implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   BlockStatus (org.apache.spark.storage.StorageLevel storageLevel, long memSize, long diskSize, long externalBlockStoreSize) { throw new RuntimeException(); }
