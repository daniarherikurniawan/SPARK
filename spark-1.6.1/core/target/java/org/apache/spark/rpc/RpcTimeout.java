 ...
 */
   ...
   * @param  awaitable  the <code>Awaitable</code> to be awaited
   * @throws RpcTimeoutException if after waiting for the specified time <code>awaitable</code>
   *         is still not ready
   * @param awaitable (undocumented)
   * @return (undocumented)
   */
  public <T extends java.lang.Object> T awaitResult (scala.concurrent.Awaitable<T> awaitable) { throw new RuntimeException(); }
}
