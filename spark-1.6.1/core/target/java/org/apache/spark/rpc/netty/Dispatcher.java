 ...
 */
  class Dispatcher implements org.apache.spark.Logging {
  ...
  private  java.util.concurrent.ConcurrentHashMap<java.lang.String, org.apache.spark.rpc.netty.Dispatcher.EndpointData> endpoints () { throw new RuntimeException(); }
  private  java.util.concurrent.ConcurrentHashMap<org.apache.spark.rpc.RpcEndpoint, org.apache.spark.rpc.RpcEndpointRef> endpointRefs () { throw new RuntimeException(); }
