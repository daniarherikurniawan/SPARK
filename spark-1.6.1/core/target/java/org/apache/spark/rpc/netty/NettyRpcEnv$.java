...
// no position
  class NettyRpcEnv$ implements org.apache.spark.Logging {
  /**
   ...
   * @return (undocumented)
   */
  public  scala.util.DynamicVariable<org.apache.spark.rpc.netty.NettyRpcEnv> currentEnv () { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.util.DynamicVariable<org.apache.spark.network.client.TransportClient> currentClient () { throw new RuntimeException(); }
}
