...
public  class ShuffleDependency<K extends java.lang.Object, V extends java.lang.Object, C extends java.lang.Object> extends org.apache.spark.Dependency<scala.Product2<K, V>> {
  private  Object _rdd () { throw new RuntimeException(); }
  ...
  // not preceding
  public   ShuffleDependency (org.apache.spark.rdd.RDD<? extends scala.Product2<K, V>> _rdd, org.apache.spark.Partitioner partitioner, scala.Option<org.apache.spark.serializer.Serializer> serializer, scala.Option<scala.math.Ordering<K>> keyOrdering, scala.Option<org.apache.spark.Aggregator<K, V, C>> aggregator, boolean mapSideCombine, scala.reflect.ClassTag<K> evidence$1, scala.reflect.ClassTag<V> evidence$2, scala.reflect.ClassTag<C> evidence$3) { throw new RuntimeException(); }
  public  org.apache.spark.rdd.RDD<scala.Product2<K, V>> rdd () { throw new RuntimeException(); }
  public  java.lang.String keyClassName () { throw new RuntimeException(); }
  public  java.lang.String valueClassName () { throw new RuntimeException(); }
  public  scala.Option<java.lang.String> combinerClassName () { throw new RuntimeException(); }
