...
public  class Accumulator<T extends java.lang.Object> extends org.apache.spark.Accumulable<T, T> {
  public  T initialValue () { throw new RuntimeException(); }
  // not preceding
     Accumulator (T initialValue, org.apache.spark.AccumulatorParam<T> param, scala.Option<java.lang.String> name, boolean internal) { throw new RuntimeException(); }
