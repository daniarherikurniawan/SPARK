 ...
 */
  ...
  public   AppClient (org.apache.spark.rpc.RpcEnv rpcEnv, java.lang.String[] masterUrls, org.apache.spark.deploy.ApplicationDescription appDescription, org.apache.spark.deploy.client.AppClientListener listener, org.apache.spark.SparkConf conf) { throw new RuntimeException(); }
  ...
  private  class ClientEndpoint implements org.apache.spark.rpc.ThreadSafeRpcEndpoint, org.apache.spark.Logging {
    ...
    private  java.util.concurrent.ThreadPoolExecutor askAndReplyThreadPool () { throw new RuntimeException(); }
   ...
   */
  public  boolean requestTotalExecutors (int requestedTotal) { throw new RuntimeException(); }
  /**
