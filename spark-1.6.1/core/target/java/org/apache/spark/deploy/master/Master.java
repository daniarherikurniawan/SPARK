package org.apache.spark.deploy.master;
  class Master implements org.apache.spark.rpc.ThreadSafeRpcEndpoint, org.apache.spark.Logging, org.apache.spark.deploy.master.LeaderElectable {
  ...
  private  java.util.concurrent.ExecutorService rebuildUIThread () { throw new RuntimeException(); }
  private  scala.concurrent.ExecutionContextExecutor rebuildUIContext () { throw new RuntimeException(); }
  ...
  private  java.util.concurrent.ConcurrentHashMap<java.lang.String, org.apache.spark.ui.SparkUI> appIdToUI () { throw new RuntimeException(); }
  ...
  private  Object recoveryCompletionTask () { throw new RuntimeException(); }
  private  Object checkForWorkerTimeOutTask () { throw new RuntimeException(); }
  ...
  /** Rebuild a new SparkUI asynchronously to not block RPC event loop */
    scala.concurrent.Future<scala.Option<org.apache.spark.ui.SparkUI>> asyncRebuildSparkUI (org.apache.spark.deploy.master.ApplicationInfo app) { throw new RuntimeException(); }
