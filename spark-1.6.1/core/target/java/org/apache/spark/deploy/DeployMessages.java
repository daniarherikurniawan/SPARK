...
/** Contains messages sent between Scheduler endpoint nodes. */
  ...
  static public  class RegisterWorker implements org.apache.spark.deploy.DeployMessage, scala.Product, scala.Serializable {
    ...
    // not preceding
    public   RegisterWorker (java.lang.String id, java.lang.String host, int port, org.apache.spark.rpc.RpcEndpointRef worker, int cores, int memory, int webUiPort, java.lang.String publicAddress) { throw new RuntimeException(); }
  }
  // no position
  static public  class RegisterWorker$ extends scala.runtime.AbstractFunction8<java.lang.String, java.lang.String, java.lang.Object, org.apache.spark.rpc.RpcEndpointRef, java.lang.Object, java.lang.Object, java.lang.Object, java.lang.String, org.apache.spark.deploy.DeployMessages.RegisterWorker> implements scala.Serializable {
    /**
