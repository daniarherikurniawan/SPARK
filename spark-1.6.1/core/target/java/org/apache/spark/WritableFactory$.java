...
public  class WritableFactory$ implements scala.Serializable {
  ...
  public   WritableFactory$ () { throw new RuntimeException(); }
   <T extends java.lang.Object, W extends org.apache.hadoop.io.Writable> org.apache.spark.WritableFactory<T> simpleWritableFactory (scala.Function1<T, W> convert, scala.reflect.ClassTag<T> evidence$34, scala.reflect.ClassTag<W> evidence$35) { throw new RuntimeException(); }
  ...
  public <T extends org.apache.hadoop.io.Writable> org.apache.spark.WritableFactory<T> writableWritableFactory (scala.reflect.ClassTag<T> evidence$36) { throw new RuntimeException(); }
}
